...
public class LoggerService extends Service {
    ...
    public static final String BROADCAST_LOCATION_STARTED = "de.alertr.chasr.broadcast.location_started";
    public static final String BROADCAST_LOCATION_STOPPED = "de.alertr.chasr.broadcast.location_stopped";
    public static final String BROADCAST_LOCATION_UPDATED = "de.alertr.chasr.broadcast.location_updated";
    public static final String BROADCAST_LOCATION_PERMISSION_DENIED = "de.alertr.chasr.broadcast.location_permission_denied";
    public static final String BROADCAST_LOCATION_NETWORK_DISABLED = "de.alertr.chasr.broadcast.network_disabled";
    public static final String BROADCAST_LOCATION_GPS_DISABLED = "de.alertr.chasr.broadcast.gps_disabled";
    public static final String BROADCAST_LOCATION_NETWORK_ENABLED = "de.alertr.chasr.broadcast.network_enabled";
    public static final String BROADCAST_LOCATION_GPS_ENABLED = "de.alertr.chasr.broadcast.gps_enabled";
    public static final String BROADCAST_LOCATION_DISABLED = "de.alertr.chasr.broadcast.location_disabled";
     ...
     *
     * @return Returns last location or null if not set
     */
